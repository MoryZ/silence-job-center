...
import com.old.silence.job.server.web.api.assembler.JobTaskResponseVOMapper;
...
public class JobTaskService {
    ...
    public JobTaskService(JobTaskDao jobTaskDao, JobLogMessageDao jobLogMessageDao) {
    ...
    private List<JobTaskResponseVO> convertJobTaskList(List<JobTask> tasks) {
        ...
        List<JobTaskResponseVO> jobTaskResponseVOs = CollectionUtils.transformToList(tasks, JobTaskResponseVOMapper.INSTANCE::convert);
