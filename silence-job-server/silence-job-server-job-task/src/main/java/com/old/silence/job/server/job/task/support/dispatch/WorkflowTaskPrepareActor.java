...
public class WorkflowTaskPrepareActor extends AbstractActor {
    ...
    public WorkflowTaskPrepareActor(List<WorkflowPrePareHandler> workflowPrePareHandlers, WorkflowTaskBatchDao workflowTaskBatchDao) {
    ...
    private void doPrepare(WorkflowTaskPrepareDTO workflowTaskPrepareDTO) {
        List<WorkflowTaskBatch> workflowTaskBatches = workflowTaskBatchDao.selectList(new LambdaQueryWrapper<WorkflowTaskBatch>()
