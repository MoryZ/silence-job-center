...
import com.old.silence.platform.job.server.common.dto.JobTaskBatchReason;
import com.old.silence.platform.job.server.common.schedule.AbstractSchedule;
import com.old.silence.platform.job.server.common.triple.Pair;
import com.old.silence.platform.job.server.domain.model.JobSummary;
import com.old.silence.platform.job.server.domain.model.WorkflowTaskBatch;
import com.old.silence.platform.job.server.dto.JobBatchSummaryResponseDO;
import com.old.silence.platform.job.server.infrastructure.persistence.dao.JobSummaryDao;
...
public class WorkflowJobSummarySchedule extends AbstractSchedule implements Lifecycle {
    ...
    public WorkflowJobSummarySchedule(JobTaskBatchDao jobTaskBatchDao, JobSummaryDao jobSummaryDao,
    ...
    private List<JobSummary> jobSummaryList(Instant triggerAt,
        ...
        for (Map.Entry<BigInteger, List<JobBatchSummaryResponseDO>> job : jobIdListMap.entrySet()) {
            ...
            jobSummary.setSystemTaskType(SystemTaskType.WORKFLOW);
