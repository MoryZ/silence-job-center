...
import com.old.silence.job.common.core.util.NetUtil;
...
import com.old.silence.job.server.web.api.assembler.ServerNodeResponseVOMapper;
...
public class PodsService {
    ...
    public PodsService(ServerNodeDao serverNodeDao, RestTemplate restTemplate, ServerProperties serverProperties) {
    ...
    public Page<ServerNodeResponseVO> pods(Page<ServerNode> pageDTO, ServerNodeQueryVO queryVO) {
        ...
        List<ServerNodeResponseVO> responseVOList = CollectionUtils.transformToList(serverNodePageDTO.getRecords(), ServerNodeResponseVOMapper.INSTANCE::convert);
