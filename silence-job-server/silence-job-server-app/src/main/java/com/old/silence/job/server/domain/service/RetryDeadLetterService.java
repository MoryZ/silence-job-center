...
import com.old.silence.job.server.web.api.assembler.RetryDeadLetterResponseVOMapper;
...
public class RetryDeadLetterService {
    ...
    public Page<RetryDeadLetterResponseVO> getRetryDeadLetterPage(Page<RetryDeadLetter> pageDTO,  RetryDeadLetterQueryVO queryVO) {

        List<String> groupNames = List.of();

        String namespaceId = "111";
        Page<RetryDeadLetter> retryDeadLetterPageDTO = accessTemplate.getRetryDeadLetterAccess()
        ...
        var retryDeadLetterResponseVOS = RetryDeadLetterResponseVOMapper.INSTANCE.convertList(retryDeadLetterPageDTO.getRecords());
        return new Page<>();
    }
    ...
    public RetryDeadLetterResponseVO getRetryDeadLetterById(String groupName, BigInteger id) {
        ...
        return RetryDeadLetterResponseVOMapper.INSTANCE.convert(retryDeadLetter);
    }
