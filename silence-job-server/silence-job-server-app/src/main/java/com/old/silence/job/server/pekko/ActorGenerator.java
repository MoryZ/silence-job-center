package com.old.silence.job.server.pekko;
...
public class ActorGenerator {
    ...
    public static SpringExtension getSpringExtension() {
        return SilenceSpringContext.getBeanByType(SpringExtension.class);
    }
    ...
    public static ActorSystem getRetryActorSystem() {
        return SilenceSpringContext.getBean("retryActorSystem", ActorSystem.class);
    }
    ...
    public static ActorSystem getCommonActorSystemSystem() {
        return SilenceSpringContext.getBean("commonActorSystem", ActorSystem.class);
    }
    ...
    public static ActorSystem getNettyActorSystem() {
        return SilenceSpringContext.getBean("nettyActorSystem", ActorSystem.class);
    }
    ...
    public static ActorSystem getJobActorSystem() {
        return SilenceSpringContext.getBean("jobActorSystem", ActorSystem.class);
    }
